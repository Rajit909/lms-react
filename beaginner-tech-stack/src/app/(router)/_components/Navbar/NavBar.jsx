    ...
    <>
      <nav className="w-full p-4 flex justify-around items-center bg-white border-b-1 border-gray-100 h-[70px] relative z-80">
        ...
        <div className=" inline-flex justify-center ">
          ...
          <a href="/">
            <button className=" bg-white hover:bg-slate-700 hover:text-white text-black border border-black font-medium rounded-xl text-sm px-5 py-2.5 text-center inline-flex items-center justify-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 active:scale-95">
              Get started
            </button>
          </a>
        </div>
